...
public class SpiderWebChart extends View{
    ...
    protected void drawSpiderWeb(Canvas canvas){
        ...
        //填�?��制边�?
        mPaintWebBorder.setStyle(Paint.Style.STROKE);
        ...
        //填�?��制边�?
        mPaintWebInnerBorder.setStyle(Paint.Style.STROKE);
        ...
        mPaintFont.setTextSize(30f);
        mPaintFont.setColor(Color.BLUE);
